({
    ...
    openmodal:function(component,event,helper) {
        ...
        component.set('v.type',myElement.className.split(" ")[5]);
        component.set('v.point',myElement.className.split(" ")[6]);
    ...
    addHeader : function(cmp, event, helper) {
        ...
        newComponents.push(["aura:html", {
            "tag": "th",
            "HTMLAttributes": {
                "class" : "assess-title col-sm-1 col-md-1 col-lg-1"
            }
        }]);
        ...
        newComponents.push(["aura:html", {
            ...
            "HTMLAttributes": {
                ...
                "id" : assessment.Id,
                "class": "col-sm-1 col-md-1 assess-title assessment-title " + assessment.Assessment_Category__c+" "+assessment.Assessment_Type__c+" "+assessment.Max_Points__c
            }
        }]);
